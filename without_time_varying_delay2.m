    ...
    for i=2:M
     ...
     %wei gai quan
        ...
        %%%%%%%%%%%response system 控制器出现
          ...
          s1(i,j+1)=s1(i,j)+h*D(1)*(s1(i+1,j)-2*s1(i,j)+s1(i-1,j))/dx/dx+h*x1(i,j)-yita(1)*JXKZ(j,1)*(s1(i-1,j)-y1(i-1,j))*h-rho_4*JXKZ(j,1)*sign(s1(i-1,j)-y1(i-1,j))*(abs(s1(i-1,j)-y1(i-1,j)))^p*h-rho_5*JXKZ(j,1)*sign(s1(i-1,j)-y1(i-1,j))*abs((s1(i-1,j)-y1(i-1,j)))^q*h-JXKZ(j,1)*(rho_1*((s1(i-1,j)-y1(i-1,j))^2+(s1(i-1,j)-y1(i-1,j))^2)*h/2)^((1+p)/2)*sign(s1(i-1,j)-y1(i-1,j))*h-JXKZ(j,1)*(rho_2*((s1(i-1,j)-y1(i-1,j))^2+(s1(i-1,j )-y1(i-1,j ))^2)*h/2)^((1+q)/2)*sign(s1(i-1,j)-y1(i-1,j))*h-JXKZ(j,1)*(rho_3*((s1(i-1,j)-y1(i-1,j))^2+(s1(i-1,j )-y1(i-1,j ))^2)*h/2)^1*sign(s1(i-1,j)-y1(i-1,j))*h;
          s2(i,j+1)=s2(i,j)+h*D(2)*(s2(i+1,j)-2*s2(i,j)+s2(i-1,j))/dx/dx+h*x2(i,j)-yita(2)*JXKZ(j,1)*(s2(i-1,j)-y2(i-1,j))*h-rho_4*JXKZ(j,1)*sign(s2(i-1,j)-y2(i-1,j))*(abs(s2(i-1,j)-y2(i-1,j)))^p*h-rho_5*JXKZ(j,1)*sign(s2(i-1,j)-y2(i-1,j))*abs((s2(i-1,j)-y2(i-1,j)))^q*h-JXKZ(j,1)*(rho_1*((s2(i-1,j)-y2(i-1,j))^2+(s2(i-1,j)-y2(i-1,j ))^2)*h/2)^((1+p)/2)*sign(s2(i-1,j)-y2(i-1,j))*h-JXKZ(j,1)*(rho_2*((s2(i-1,j)-y2(i-1,j))^2+(s2(i-1,j )-y2(i-1,j ))^2)*h/2)^((1+q)/2)*sign(s2(i-1,j)-y2(i-1,j))*h-JXKZ(j,1)*(rho_3*((s2(i-1,j)-y2(i-1,j))^2+(s2(i-1,j )-y2(i-1,j ))^2)*h/2)^1*sign(s2(i-1,j)-y2(i-1,j))*h;
          s3(i,j+1)=s3(i,j)+h*D(3)*(s3(i+1,j)-2*s3(i,j)+s3(i-1,j))/dx/dx+h*x3(i,j)-yita(3)*JXKZ(j,1)*(s3(i-1,j)-y3(i-1,j))*h-rho_4*JXKZ(j,1)*sign(s3(i-1,j)-y3(i-1,j))*(abs(s3(i-1,j)-y3(i-1,j)))^p*h-rho_5*JXKZ(j,1)*sign(s3(i-1,j)-y3(i-1,j))*abs((s3(i-1,j)-y3(i-1,j)))^q*h-JXKZ(j,1)*(rho_1*((s3(i-1,j)-y3(i-1,j))^2+(s3(i-1,j)-y3(i-1,j ))^2)*h/2)^((1+p)/2)*sign(s3(i-1,j)-y3(i-1,j))*h-JXKZ(j,1)*(rho_2*((s3(i-1,j)-y3(i-1,j))^2+(s3(i-1,j )-y3(i-1,j ))^2)*h/2)^((1+q)/2)*sign(s3(i-1,j)-y3(i-1,j))*h-JXKZ(j,1)*(rho_3*((s3(i-1,j)-y3(i-1,j))^2+(s3(i-1,j )-y3(i-1,j ))^2)*h/2)^1*sign(s3(i-1,j)-y3(i-1,j))*h;
          s4(i,j+1)=s4(i,j)+h*D(4)*(s4(i+1,j)-2*s4(i,j)+s4(i-1,j))/dx/dx+h*x4(i,j)-yita(4)*JXKZ(j,1)*(s4(i-1,j)-y4(i-1,j))*h-rho_4*JXKZ(j,1)*sign(s4(i-1,j)-y4(i-1,j))*(abs(s4(i-1,j)-y4(i-1,j)))^p*h-rho_5*JXKZ(j,1)*sign(s4(i-1,j)-y4(i-1,j))*abs((s4(i-1,j)-y4(i-1,j)))^q*h-JXKZ(j,1)*(rho_1*((s4(i-1,j)-y4(i-1,j))^2+(s4(i-1,j)-y4(i-1,j ))^2)*h/2)^((1+p)/2)*sign(s4(i-1,j)-y4(i-1,j))*h-JXKZ(j,1)*(rho_2*((s4(i-1,j)-y4(i-1,j))^2+(s4(i-1,j )-y4(i-1,j ))^2)*h/2)^((1+q)/2)*sign(s4(i-1,j)-y4(i-1,j))*h-JXKZ(j,1)*(rho_3*((s4(i-1,j)-y4(i-1,j))^2+(s4(i-1,j )-y4(i-1,j ))^2)*h/2)^1*sign(s4(i-1,j)-y4(i-1,j))*h;
          s5(i,j+1)=s5(i,j)+h*D(5)*(s5(i+1,j)-2*s5(i,j)+s5(i-1,j))/dx/dx+h*x5(i,j)-yita(5)*JXKZ(j,1)*(s5(i-1,j)-y5(i-1,j))*h-rho_4*JXKZ(j,1)*sign(s5(i-1,j)-y5(i-1,j))*(abs(s5(i-1,j)-y5(i-1,j)))^p*h-rho_5*JXKZ(j,1)*sign(s5(i-1,j)-y5(i-1,j))*abs((s5(i-1,j)-y5(i-1,j)))^q*h-JXKZ(j,1)*(rho_1*((s5(i-1,j)-y5(i-1,j))^2+(s5(i-1,j)-y5(i-1,j ))^2)*h/2)^((1+p)/2)*sign(s5(i-1,j)-y5(i-1,j))*h-JXKZ(j,1)*(rho_2*((s5(i-1,j)-y5(i-1,j))^2+(s5(i-1,j )-y5(i-1,j ))^2)*h/2)^((1+q)/2)*sign(s5(i-1,j)-y5(i-1,j))*h-JXKZ(j,1)*(rho_3*((s5(i-1,j)-y5(i-1,j))^2+(s5(i-1,j )-y5(i-1,j ))^2)*h/2)^1*sign(s5(i-1,j)-y5(i-1,j))*h;
          s6(i,j+1)=s6(i,j)+h*D(6)*(s6(i+1,j)-2*s6(i,j)+s6(i-1,j))/dx/dx+h*x6(i,j)-yita(6)*JXKZ(j,1)*(s6(i-1,j)-y6(i-1,j))*h-rho_4*JXKZ(j,1)*sign(s6(i-1,j)-y6(i-1,j))*(abs(s6(i-1,j)-y6(i-1,j)))^p*h-rho_5*JXKZ(j,1)*sign(s6(i-1,j)-y6(i-1,j))*abs((s6(i-1,j)-y6(i-1,j)))^q*h-JXKZ(j,1)*(rho_1*((s6(i-1,j)-y6(i-1,j))^2+(s6(i-1,j)-y6(i-1,j ))^2)*h/2)^((1+p)/2)*sign(s6(i-1,j)-y6(i-1,j))*h-JXKZ(j,1)*(rho_2*((s6(i-1,j)-y6(i-1,j))^2+(s6(i-1,j )-y6(i-1,j ))^2)*h/2)^((1+q)/2)*sign(s6(i-1,j)-y6(i-1,j))*h-JXKZ(j,1)*(rho_3*((s6(i-1,j)-y6(i-1,j))^2+(s6(i-1,j )-y6(i-1,j ))^2)*h/2)^1*sign(s6(i-1,j)-y6(i-1,j))*h;
